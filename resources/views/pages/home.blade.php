        ...
        <div id="carouselHome" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="item active">
                    <div class="background-main" style="background-image:url('assets/img/backgrounds/bg1.png');" data-0="background-position:0px 0px;" data-500="background-position:0px -250px;">
                        <div class="container">
                            <div class="row carousel-content center-vertically-right">
                                ...
                                <div class="fadeInLeft-animated" data-animation="fadeInLeft">
                                    <div class="col-sm-6 col-sm-offset-1">
                                        <img src="assets/img/showcase-full.png" class="img-responsive carousel-image" alt="Responsive Showcase">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                {{-- Item 2 --}}
                <div class="item">
                    <div style="background-image:url('assets/img/backgrounds/bg4.jpg');" data-0="background-position:0px 0px;" data-500="background-position:0px -250px;">
                        <div class="container">
                            <div class="row carousel-content center-vertically-left">
                                <div class="fadeInLeft-animated" data-animation="fadeInLeft">
                                    <div class="col-sm-6 hidden-xs">
                                        <img src="assets/img/showcase2.png" class="img-responsive carousel-image" alt="Responsive Showcase">
                                    </div>
                                </div>
                                <div class="fadeInRight-animated" data-animation="fadeInRight">
                ...
                {{-- Item 3 --}}
                <div class="item">
                    <div style="background-image:url('assets/img/backgrounds/bg5.jpg');" data-0="background-position:0px 0px;" data-500="background-position:0px -250px;">
                        <div class="container">
                            <div class="row carousel-content center-vertically-right">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-6" data-sr="enter bottom">
                    <img src="assets/img/showcase.png" class="img-responsive showcase-image" alt="Responsive Showcase">
                </div>
            </div>
            {{-- /Accordion --}}
        </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-4" data-sr="enter left">
                    <div id="homeCarousel2" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <div style="background-image:url('assets/img/backgrounds/stock2.jpg'); height:260px;"></div>
                            </div>
                            <div class="item">
                                <div style="background-image:url('assets/img/backgrounds/stock7.jpg'); height:260px"></div>
                            </div>
                            <div class="item">
                                <div style="background-image:url('assets/img/backgrounds/stock1.jpg'); height:260px"></div>
                            </div>
                        </div>
        ...
        <div class="container">
                ...
                <div class="col-lg-12">
                    ...
                    <div id="owl-carousel-thumb" class="owl-carousel">
                        <div class="thumbnail">
                            ...
                            <img src="assets/img/backgrounds/stock1.jpg" alt="...">
                        </div>
                        <div class="thumbnail">
                            <div class="caption">
                            ...
                            <img src="assets/img/backgrounds/stock2.jpg" alt="...">
                        </div>
                        <div class="thumbnail">
                            <div class="caption">
                                <div class="thumbnail-caption-holder">
                            ...
                            <img src="assets/img/backgrounds/stock3.jpg" alt="...">
                        </div>
                        <div class="thumbnail">
                            <div class="caption">
                                <div class="thumbnail-caption-holder">
                            ...
                            <img src="assets/img/backgrounds/stock4.jpg" alt="...">
                        </div>
                        <div class="thumbnail">
                            <div class="caption">
                                <div class="thumbnail-caption-holder">
                            ...
                            <img src="assets/img/backgrounds/stock5.jpg" alt="...">
                        </div>
                        <div class="thumbnail">
                            <div class="caption">
                                <div class="thumbnail-caption-holder">
                            ...
                            <img src="assets/img/backgrounds/stock6.jpg" alt="...">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-2 col-xs-4 mb30-xs" data-sr="enter left">
                    <a href="#"><img src="assets/img/logos/boomerang.png" class="img-responsive clients-img" alt="Client 1"></a>
                </div>
                <div class="col-sm-2 col-xs-4 mb30-xs" data-sr="enter left">
                    <a href="#"><img src="assets/img/logos/backlight.png" class="img-responsive clients-img" alt="Client 2"></a>
                </div>
                <div class="col-sm-2 col-xs-4 mb30-xs" data-sr="enter left">
                    <a href="#"><img src="assets/img/logos/equi.png" class="img-responsive clients-img" alt="Client 3"></a>
                </div>
                <div class="col-sm-2 col-xs-4" data-sr="enter left">
                    <a href="#"><img src="assets/img/logos/ome.png" class="img-responsive clients-img" alt="Client 4"></a>
                </div>
                <div class="col-sm-2 col-xs-4" data-sr="enter left">
                    <a href="#"><img src="assets/img/logos/euro.png" class="img-responsive clients-img" alt="Client 5"></a>
                </div>
                <div class="col-sm-2 col-xs-4" data-sr="enter left">
                    <a href="#"><img src="assets/img/logos/micro.png" class="img-responsive clients-img" alt="Client 6"></a>
                </div>
            </div>
        </div>
    </section>
